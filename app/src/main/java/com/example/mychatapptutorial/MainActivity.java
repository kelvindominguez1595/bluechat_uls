    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        msendotp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(number.isEmpty())
                {
                    Toast.makeText(getApplicationContext(),"El camo número es obligatorio",Toast.LENGTH_SHORT).show();
                }
                else if(number.length()<8)
                {
                    Toast.makeText(getApplicationContext(),"Escriba un número que exista",Toast.LENGTH_SHORT).show();
                }
                else
                {
